...
$(BUILD_DIR)/bannex.bin: $(BANNEX_OBJS) $(BANNEX_DEPS) $(CFG_DIR)/bannex-x16.cfg
	...
	`${BUILD_DIR}/../../findsymbols ${BUILD_DIR}/basic.sym basic_fa buf chrgot crambank curlin eormsk fac facho facmo index index1 index2 lp_dopause lp_screenpause poker rencur reninc rennew renold rentmp rentmp2 txtptr txttab valtyp vartab verck` \
	...
	`${BUILD_DIR}/../../findsymbols ${BUILD_DIR}/kernal.sym curs_y llen mode nlines`
